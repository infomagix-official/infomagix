...
const ChamberControlDAQ = () => {
  return (
    <div className="product-container">
      ...
      <div className="product-section">
        <h2 className="product-title">챔버 Control</h2>
      ...
      <div className="product-section">
        <h2 className="product-title">Data Acquisition</h2>
      ...
      <div className="product-section">
        <h2 className="product-title">주변장치 Interface</h2>
      ...
      <div className="product-section">
        <h2 className="product-title">시스템 구성도</h2>
        <h2 style={{
          background: "red"
        }}>image1</h2>
        <h2 style={{
      ...
      <div className="product-section">
        <h2 className="product-title">환경챔버 Host Control 시스템 구성</h2>
        <h2 style={{
          background: "red"
        }}>image3</h2>        
      </div>
      ...
      <div className="product-section">
        <h2 className="product-title">적용실적</h2>
      ...
      <div className='product-section'>
        <h2 className="product-title">Chamber Control</h2>
        <ul>
          <li>Chamber Control</li>
          <ul>
            <li>PLC Network Interface</li>
            <li>Stand-Alone Chamber Control System</li>
            <li>Chamber Operating/Fault/Alarm Event Message 자동저장</li>
            <li>Chamber의 모든 Data와 Vehicle Data가 동시에 표시되고, 저장 가능</li>
          </ul>
          <li>Refrigeration System Interface</li>
          <ul>
          ...
          <li>냉동기로부터 발생된 Message 및 냉동기 운전 물리량은 Chamber PC에 자동으로 이력 저장됩니다.</li>
          <h2 style={{
            background: "red"
          }}>image4</h2>
        </ul>
      ...
      <div className="product-section">
        <h2 className="product-title">Software 사양</h2>

        <div className="product-block">
          <p className="product-text"><b>Security</b></p>
          <p className="product-text">Log-in Password 방식의 Security 기능</p>
        </div>

        <div className="product-block">
          <p className="product-text"><b>Test Sequencer</b></p>
          <ul className="product-list">
        ...
        <div className="product-block">
          <p className="product-text"><b>chamber interface</b></p>
          <ul className="product-list">
          </ul>
        </div>

        <div className="product-block">
          <p className="product-text"><b>Robot interface</b></p>
          <ul className="product-list">
          </ul>
        </div>

        <div className="product-block">
          <p className="product-text"><b>Dynamo interface</b></p>
          <ul className="product-list">
          </ul>
        </div>

        <div className="product-block">
          <p className="product-text"><b>Test Data Calculation</b></p>
          <ul className="product-list">
          </ul>
        </div>

        <div className="product-block">
          <p className="product-text"><b>Data Analysis</b></p>
          <ul className="product-list">
        ...
        <div className="product-block">
          <p className="product-text"><b>Diagnostics</b></p>
          <p className="product-text">
        ...
        <div className="product-block">
          <p className="product-text"><b>Configuration</b></p>
          <ul className="product-list">
        ...
        <div className="product-block">
          <p className="product-text"><b>Operator Interfaces / Displays</b></p>
          <ul className="product-list">
            <li></li>
            <li></li>
            <li></li>
