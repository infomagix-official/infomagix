...
const ActiveEyeSoftware = () => {
  return (
    <div class="product-container">
      ...
      <div class="product-section">
        <h2 class="product-title">UI Flexibility</h2>
        <div class="product-block">
          <p class="product-text"><b>탁월한 그래픽 편집 기능</b></p>
          <ul class="product-list">
            <li>Animation 지원</li>
            <li>PCX, BMP, GIF, DXF 등 다양한 그래픽 포맷 호환</li>
          </ul>
        </div>

        <div class="product-block">
          <p class="product-text"><b>간편한 Network Setup Architecture</b></p>
        </div>

        <div class="product-block">
          <p class="product-text">
            기본 제공되는 Template을 활용하여 System Page를 손쉽게 수정 가능
          </p>
        </div>

        <div class="product-block">
          <p class="product-text"><b>Script 통합 Language</b></p>
          <ul class="product-list">
            <li>C 또는 Pascal 수준의 통합 Script Language 제공</li>
            <li>ActiveEye System 내부에서 직접 실행</li>
          </ul>
        </div>

        <div class="product-block">
          <p class="product-text"><b>강력한 Report 기능</b></p>
          <ul class="product-list">
            <li>ASCII Format, Excel Format 리포트 저장</li>
            <li>화면, 프린터, 파일, Database 파일 출력 가능</li>
          </ul>
        </div>
      </div>

      <div class="product-section">
        <h2 class="product-title">Graphic Interface</h2>

        <ul class="product-list">
          <li>사용자 친화적인 GUI 환경 제공</li>
          <li>마우스 클릭만으로 모든 시스템 감시 및 제어 가능</li>
          <li>동시에 여러 화면 표시 가능</li>
          <li>Resizing 기능 제공으로 화면 관리 용이</li>
        </ul>
      </div>
      <div class="product-section">
        <h2 class="product-title">Alarm Monitor</h2>
        <ul class="product-list">
          <li>발생 알람을 시간 순서 기준으로 실시간 화면 및 Summary 화면에서 관리</li>
          <li>알람 데이터 저장 및 출력 가능</li>
          <li>현장 알람 및 데이터는 Historical Database에 저장되어 리포트 출력</li>
        </ul>
      </div>

      <div class="product-section">
        <h2 class="product-title">Real-time Display</h2>
        <ul class="product-list">
          <li>데이터 서버로부터 실시간 데이터 수집 및 표시</li>
          <li>History Data 파일 저장 및 Trend, X-Y Plot 표시</li>
          <li>중요 공정 데이터 및 알람 데이터 표시</li>
          <li>네트워크 상 모든 컴퓨터에서 데이터 조회 가능</li>
          <li>서버를 통한 History 데이터 조회 가능</li>
          <li>태그별 History 데이터 표시</li>
          <li>최대 / 최소 / 평균 / 편차 값 표시</li>
          <li>공정별 데이터 관리로 운전 상황 분석 용이</li>
        </ul>
      </div>
    </div>
  )
...
export default ActiveEyeSoftware;