...
- Functioning as a real-time fuel efficiency computer and a trip computer
 
### ▶ Features

- Microprocessor-based controller, 5” LCD, GPS module
- Built-in CAN communication module, SD data storage medium, and power unit
- Built-in 100Hz or 20Hz GPS
...
- Built‑in ARM‑based processor controller, 5” LCD, 20 Hz or 100 Hz GPS module, CAN communication module, I/O module, SD data storage device, and power supply
- Equipped with either a 100 Hz GPS or a 20 Hz GPS module
- Provides vehicle speed output at 100 Hz when using the 100 Hz GPS module

### ▶ Vehicle CAN data interface
...
- distance pulse output and speed analog output

### ▶ RS232 and CAN output

- 100Hz output of vehicle speed and location data
- 20Hz output of other GPS data

### ▶ Dimension

- Vibration-resistant and moisture-resistant aluminum case suitable for use in a vehicle
- Dimension: 150mm x 100mm x 30mm

### ▶ Operating environment

- Suitable for vehicle environment of rapid deceleration and acceleration
- Power specification: DC 9 ~ 30V
- Operating temperature: -20 °C ~ 60 °C

## Comparison: VCD‑5GPS vs. GPS Speed Sensor vs. L350

### ▶ VCD‑5GPS – GPS Speed Sensor Specifications

- Speed measurement range: 0.0 ~ 500.0 kph
- Speed measurement accuracy: ±0.2 kph
- Distance measurement resolution: 1.0 cm
- Distance measurement accuracy: ±0.2%
- Update rate: 10 ms (100 Hz)
- Additional GPS data: Provides position data and other GPS information

### ▶ L350 External Speed Sensor Specifications

- Speed measurement range: 0.3 ~ 250.0 kph
- Speed measurement accuracy: ±0.2%
- Distance measurement resolution: 1.5 cm
- Distance measurement accuracy: ±0.2%
- Update rate: 4 ms (250 Hz)
- Measurement latency: 10 ms ~ 100 ms delay due to filtering and averaging processes

### ▶ Key Advantages of VCD‑5GPS

- Utilizes an integrated 100 Hz GPS sensor
- Enables testing using GPS‑based speed and distance measurements in open environments
- Provides access to GPS position data from the built‑in module
- Achieves improved speed and distance precision (±0.2 kph)
- Simplifies speed‑measurement equipment and system configuration
- Minimizes the number of external measurement devices required
- Reduces overall system weight
- Offers a compact and lightweight main measurement unit
